...
(function(global, factory) {
    ...
    var config = {
        ...
        /**
         * Show jadwalion mode tip message on boot?
         */
        jadwalionTip: "development" !== "jadwalion",

        /**
         * Whether to enable devtools
         */
        devtools: "development" !== "jadwalion",
    ...
    strats.props = strats.methods = strats.inject = strats.computed = function(
        ...
        if (childVal && "development" !== "jadwalion") {
            assertObjectType(key, childVal, vm);
        }
        if (!parentVal) {
            return childVal;
    ...
    if (inBrowser) {
        setTimeout(function() {
            ...
            if (
                config.jadwalionTip !== false &&
                typeof console !== "undefined"
            ) {
                console[console.info ? "info" : "log"](
                    "You are running Vue in development mode.\n" +
                        "Make sure to turn on jadwalion mode when deploying for jadwalion.\n" +
        ...
        if (!options.render) {
            ...
            if (template) {
                ...
                var ref = compileToFunctions(
                    template,
                    {
                        outputSourceRange: "development" !== "jadwalion",
