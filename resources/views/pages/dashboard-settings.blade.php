  ...
  <div class="container-fluid">
    <div class="dashboard-heading">
      ...
      <p class="dashboard-subtitle">
        Membuat tokomu menjadi sangat untung!
      </p>
    </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="id_member" value="{{ $user->id_member }}"/>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      >
                        <input
                          ...
                          id="openStoreFalse"
                          value="0"
                          {{ $user->member_status == 0 || $user->member_status == NULL ? 'checked' : '' }}
                        />
                        <label
                          for="openStoreFalse"
                          class="custom-control-label"
